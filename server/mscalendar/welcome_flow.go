...
func (wf *WelcomeFlow) makeSteps() {
	...
	steps = append(steps, &flow.EmptyStep{
		...
		TrueResponseMessage:  "We'll send you confirmations before updating your status.",
		FalseResponseMessage: "We'll update your status automatically with no confirmation.",
	}, &flow.SimpleStep{
		...
		Message:              "Do you want to receive notifications when you're invited to an event?",
