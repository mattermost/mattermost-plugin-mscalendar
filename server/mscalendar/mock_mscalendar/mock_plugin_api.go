...
// CleanKVStore mocks base method
func (m *MockPluginAPI) CleanKVStore() error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CleanKVStore")
	ret0, _ := ret[0].(error)
	return ret0
}

// CleanKVStore indicates an expected call of CleanKVStore
func (mr *MockPluginAPIMockRecorder) CleanKVStore() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CleanKVStore", reflect.TypeOf((*MockPluginAPI)(nil).CleanKVStore))
}
