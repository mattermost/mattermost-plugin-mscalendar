    ...
    >
        ...
        <g transform='translate(2.5 2) scale(0.0475)'>
            ...
            <path
                fillRule='evenodd'
                clipRule='evenodd'
                d='M234 107H354C359.523 107 364 111.477 364 117V149V262V279V282C364 287.523 359.523 292 354 292H234V280H351V149H234V107Z'
                fill='#0072C6'
            />
            <defs>
